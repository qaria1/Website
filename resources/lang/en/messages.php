<?php return array (
  ...
  'domain' => 'Domain',
  '(For ex: demo.martreza.com)' => '(For ex: demo.martreza.com)',
  ...
  'to_view_your_order_sign_into_your_Martreza' => 'To view your order sign into your Martreza',
  'to_view_your_order_sign_into_your Martreza account_and_please_click_below_button' => 'To view your order sign into your Martreza account and please click below button',
  ...
  'Add_Domain_(For_ex:_demo.martreza.com)' => 'Add Domain (For ex: demo.martreza.com)',
  ...
  'invite_your_friends_&_businesses' => 'Invite your friends & businesses',
  'they_register_Martreza_with_special_offer' => 'They register Martreza with special offer',
  ...
  'rejected_Refund_Request' => 'Rejected Refund Request',
  ...
  'vendor_Product_Request' => 'Vendor Product Request',
  'vendor_Sign_Up_Request' => 'Vendor Sign Up Request',
  'you_have_new_notification_please_check' => 'You have new notification please check',
  'version' => 'Version',
  'exclusive_brands' => 'Exclusive brands',
  'product_rejections' => 'Product rejections',
  ...
  'wishlisted_Products' => 'Wishlisted Products',
  'if_you_do_not_want_to_set_please_enter_0_as_default' => 'If you do not want to set please enter 0 as default',
  'admin_login' => 'Admin login',
  'subscription' => 'Subscription',
  'total_new_pending_orders' => 'Total new pending orders',
  'total_new_pending_refund_requests' => 'Total new pending refund requests',
  'delivery_class' => 'Delivery class',
  'Refund_Day_limit' => 'Refund Day limit',
  'refund_day_limit' => 'Refund day limit',
  'total_new_requests' => 'Total new requests',
  'total_new_sign_up_requests' => 'Total new sign up requests',
  'sign_Up_Requests' => 'Sign Up Requests',
  'free_Plan_Waiting_List' => 'Free Plan Waiting List',
  'expiring_Vendors' => 'Expiring Vendors',
  'enter_age' => 'Enter age',
  'wait_for_your_request_to_be_approved' => 'Wait for your request to be approved',
  'age' => 'Age',
  ...
  'We are using this time to give our website a revamp!' => 'We are using this time to give our website a revamp!',
  'refund_policy_detail' => 'Refund policy detail',
  'view_refund_policy_note' => 'View refund policy note',
  'refund_policy_note' => 'Refund policy note',
  ...
  'Find_your_favourite_brands' => 'Find your favourite brands',
  'sex' => 'Sex',
  'successfully_registered' => 'Successfully registered',
  'vendor_Sign_Up_Request_List' => 'Vendor Sign Up Request List',
  'refund_&_Return_Policy' => 'Refund & Return Policy',
  ...
  'system_settings' => 'System settings',
  'offline_Payment_allows_customers_to_use_external_payment_methods._They_must_share_payment_details_afterward._Admin_can_set_whether_customers_can_make_offline_payments_by_enabling/disabling_this_button. ' => 'Offline Payment allows customers to use external payment methods. They must share payment details afterward. Admin can set whether customers can make offline payments by enabling/disabling this button. ',
  'if_disabled_the_Pay_on_Delivery_payment_method_will_be_hidden_from_the_checkout_page' => 'If disabled the Pay on Delivery payment method will be hidden from the checkout page',
  'if_enabled_customers_can_select_Pay_on_Delivery_as_a_payment_method_during_checkout' => 'If enabled customers can select Pay on Delivery as a payment method during checkout',
  'is_required' => 'Is required',
  'balance_credited_for_completing_their_profile' => 'Balance credited for completing their profile',
  'balance_credited_for_reviewing_an_item' => 'Balance credited for reviewing an item',
  'balance_credited_for_checking_our_social_media' => 'Balance credited for checking our social media',
  'the_cost_must_be_a_number' => 'The cost must be a number',
  'the_duration_field_is_required' => 'The duration field is required',
  'trial_duration_in_days' => 'Trial duration in days',
  'please_make_sure_to_input_the_value_in_days' => 'Please make sure to input the value in days',
  'in_days' => 'In days',
  'select_subscription' => 'Select subscription',
  'duration_in_days' => 'Duration in days',
  'balance_credited_for_referring_a_user' => 'Balance credited for referring a user',
  'subscription_type' => 'Subscription type',
  'in_gregorian' => 'In gregorian',
  'birth_date' => 'Birth date',
  'please_enter_your_additional_phone_number' => 'Please enter your additional phone number',
  'enter_additional_phone_number' => 'Enter additional phone number',
  'please_provide_valid_phone_number' => 'Please provide valid phone number',
  'get_new password' => 'Get new password',
  'trial_subscription_setting' => 'Trial subscription setting',
  'add_billing_type' => 'Add billing type',
  'Monthly' => 'Monthly',
  'price_on_billing' => 'Price on billing',
  'balance_credited_visiting_site_or_App_in_24hrs' => 'Balance credited visiting site or App in 24hrs',
  ...
  'please_provide_valid_phone_number.' => 'Please provide valid phone number.',
  'use_the_code_to_change_your_password_on_our_secure_website' => 'Use the code to change your password on our secure website',
  'select_number_of_days' => 'Select number of days',
  'refund_number_of_days' => 'Refund number of days',
  'select_delivery_class' => 'Select delivery class',
  'delivery_code' => 'Delivery code',
  'delivery_class_list' => 'Delivery class list',
  'new_delivery_Description' => 'New delivery Description',
  'delivery_Description' => 'Delivery Description',
  'NUMBER_OF_DAYS' => 'NUMBER OF DAYS',
  'category_refund_dates_list' => 'Category refund dates list',
  'new_category_refund_dates_Number' => 'New category refund dates Number',
  'Category_refund_dates_Number' => 'Category refund dates Number',
  'category_refund_dates_Setup' => 'Category refund dates Setup',
  'refund_date_added_successfully' => 'Refund date added successfully',
  'main_Delivery_class' => 'Main Delivery class',
  'new_category_number_days' => 'New category number days',
  'category_number_of_days' => 'Category number of days',
  'delivery_class_update' => 'Delivery class update',
  'refund_date_updated_successfully' => 'Refund date updated successfully',
  'new_Category_Code' => 'New Category Code',
  'category_Code' => 'Category Code',
  'category_code_is_required' => 'Category code is required',
  'select_refund_number_of_days' => 'Select refund number of days',
  'new_Category_code' => 'New Category code',
  'main_number_of_days' => 'Main number of days',
  'new_delivery_Code' => 'New delivery Code',
  'Model' => 'Model',
  'Material' => 'Material',
  'product_Code' => 'Product Code',
  'newest' => 'Newest',
  'oldest' => 'Oldest',
  'top_buyer_by_volume' => 'Top buyer by volume',
  'top_buyer' => 'Top buyer',
  'we_will_send_email you a temporary code' => 'We will send email you a temporary code',
  'fill_in_your_email_address_below' => 'Fill in your email address below',
  'house_no' => 'House no',
  'approve_vendor' => 'Approve vendor',
  'write_your_reject_reason_here' => 'Write your reject reason here',
  'give_a_reject_reason' => 'Give a reject reason',
  ...
  'exclusive_Brand_Add' => 'Exclusive Brand Add',
  'exclusive_Brand_Setup' => 'Exclusive Brand Setup',
  'exclusive_Brand_List' => 'Exclusive Brand List',
  'vendor_Name' => 'Vendor Name',
  'no_vendor' => 'No vendor',
  'exclusive_brand' => 'Exclusive brand',
  'manage_exclusive_brands' => 'Manage Exclusive Brands',
  'exclusive_brand_help_text' => 'Pick registered shops to feature them on the Exclusive Brands page.',
  'search_by_shop_name' => 'Search by shop name',
  'shop_added_to_exclusive_brands' => 'Shop added to Exclusive Brands',
  'shop_removed_from_exclusive_brands' => 'Shop removed from Exclusive Brands',
  'no_exclusive_brand_found' => 'No exclusive brand found',
  'view_all_products' => 'View all products',
  'your_input_here' => 'Your input here',
  'if_enabled _the_pay_on_delivery_option_will_be_available_on_the_system' => 'If enabled  the pay on delivery option will be available on the system',
  'want_to_Turn_ON_the_Pay_On_Delivery_option' => 'Want to Turn ON the Pay On Delivery option',
  'want_to_Turn_OFF_the_Pay_On_Delivery_option' => 'Want to Turn OFF the Pay On Delivery option',
  'want_to_Turn_ON_Offline_Payment_Methods' => 'Want to Turn ON Offline Payment Methods',
  'want_to_Turn_OFF_Offline_Payment_Methods' => 'Want to Turn OFF Offline Payment Methods',
  ...
  'plan_name' => 'Plan name',
  'plan_code' => 'Plan code',
  'maximum_product_upload' => 'Maximum product upload',
  'maximum_product_lifecycle' => 'Maximum product lifecycle',
  'billing_type' => 'Billing type',
  'subscription_billing_type_setting' => 'Subscription billing type setting',
  'add_new_billing_type' => 'Add new billing type',
  'buyer' => 'Buyer',
  'apply_now' => 'Apply now',
  'filter_vendors' => 'Filter vendors',
  'select_plan' => 'Select plan',
  'select_subscription_first' => 'Select subscription first',
  'top_seller' => 'Top seller',
  'older' => 'Older',
  'reject_vendor' => 'Reject vendor',
  'brand_shop' => 'Brand shop',
  'vendor_suspension' => 'Vendor suspension',
  'give_a_suspend_reason' => 'Give a suspend reason',
  'write_your_suspend_reason_here' => 'Write your suspend reason here',
  ...
  'all_vendors_global_rule' => 'All vendors global rule',
  'min_price' => 'Min price',
  'max_price' => 'Max price',
  ...
  'available_vendors_count' => 'Available vendors count',
  'new_vendor_default_subscription' => 'New vendor default subscription',
  'select_the_subscription_plan_and_duration_that_will_automatically_be_assigned_to_all_newly_registered_vendors' => 'Select the subscription plan and duration that will automatically be assigned to all newly registered vendors',
  'select_subscription_plan' => 'Select subscription plan',
  'how_many_days_the_new_vendor_will_have_this_subscription_after_signing_up' => 'How many days the new vendor will have this subscription after signing up',
  'e.g. 30  60  90' => 'E.g. 30  60  90',
  'new_vendor_default_subscription_updated_successfully' => 'New vendor default subscription updated successfully',
  'current_setting' => 'Current setting',
  'new_subscription' => 'New subscription',
  'add_subscription_plan' => 'Add subscription plan',
  'add_new_subscription_plan' => 'Add new subscription plan',
  'plan_details' => 'Plan details',
  'e.g. Premium  Gold  Basic' => 'E.g. Premium  Gold  Basic',
  'a_short_unique_code_for_the_plan_e.g._P_G_B' => 'A short unique code for the plan e.g. P G B',
  'e.g. P' => 'E.g. P',
  'leave_0_for_unlimited' => 'Leave 0 for unlimited',
  'create_plan' => 'Create plan',
  'after_creating_the_plan_you_can_add_billing_types_to_it' => 'After creating the plan you can add billing types to it',
  'the_plan_code_should_be_unique_and_short' => 'The plan code should be unique and short',
  'set_available_vendors_to_0_for_unlimited_slots' => 'Set available vendors to 0 for unlimited slots',
  'you_can_edit_the_plan_later_using_the_edit_button' => 'You can edit the plan later using the edit button',
  'pricing' => 'Pricing',
  'set_the_price_for_each_billing_type_leave_blank_to_skip' => 'Set the price for each billing type leave blank to skip',
  'Executive Analytics Command Center' => 'Executive Analytics Command Center',
  'Comprehensive real-time platform data & business decision insights' => 'Comprehensive real-time platform data & business decision insights',
  'From Date' => 'From Date',
  'To Date' => 'To Date',
  'Today' => 'Today',
  'Apply Filter' => 'Apply Filter',
  'Total Gross Revenue' => 'Total Gross Revenue',
  'Delivered Orders GMV' => 'Delivered Orders GMV',
  'Net Admin Earning' => 'Net Admin Earning',
  'In-house + Commission' => 'In-house + Commission',
  'Lifetime Orders Placed' => 'Lifetime Orders Placed',
  'Pending Withdrawals' => 'Pending Withdrawals',
  'Seller & Deliveryman Payouts' => 'Seller & Deliveryman Payouts',
  'Financial & Earnings' => 'Financial & Earnings',
  'Orders & Funnel' => 'Orders & Funnel',
  'Vendors & Subscriptions' => 'Vendors & Subscriptions',
  'Customers & Retention' => 'Customers & Retention',
  'Products & Catalog' => 'Products & Catalog',
  'Delivery & Fleet' => 'Delivery & Fleet',
  'Refunds & Support' => 'Refunds & Support',
  'Activity & Alerts' => 'Activity & Alerts',
  'Financial Performance Overview' => 'Financial Performance Overview',
  'Monthly View' => 'Monthly View',
  'Daily Breakdown' => 'Daily Breakdown',
  'Refresh Financial Data' => 'Refresh Financial Data',
  'Direct In-house product revenue' => 'Direct In-house product revenue',
  'Commission Earned' => 'Commission Earned',
  'Vendor order sales commissions' => 'Vendor order sales commissions',
  'Delivery Charges Earned' => 'Delivery Charges Earned',
  'Total shipping charge revenue' => 'Total shipping charge revenue',
  'Pending Admin Balance' => 'Pending Admin Balance',
  'Unsettled order amounts' => 'Unsettled order amounts',
  'Payment Methods Distribution' => 'Payment Methods Distribution',
  'Orders Count' => 'Orders Count',
  'Total Volume' => 'Total Volume',
  'Cash / Pay on Delivery' => 'Cash / Pay on Delivery',
  'Digital / Online Payment' => 'Digital / Online Payment',
  'Customer Wallet' => 'Customer Wallet',
  'Offline Payment' => 'Offline Payment',
  'Ecosystem Wallet Balances' => 'Ecosystem Wallet Balances',
  'Total Vendor Wallets Net Balance' => 'Total Vendor Wallets Net Balance',
  'Earned minus withdrawn' => 'Earned minus withdrawn',
  'Total Deliveryman Wallets Balance' => 'Total Deliveryman Wallets Balance',
  'Current delivery earnings' => 'Current delivery earnings',
  'Total Customer Wallets Balance' => 'Total Customer Wallets Balance',
  'Customer stored funds' => 'Customer stored funds',
  'Order Conversion & Lifecycle Funnel' => 'Order Conversion & Lifecycle Funnel',
  'Fulfillment Success Rate' => 'Fulfillment Success Rate',
  ...
  'Canceled before dispatch' => 'Canceled before dispatch',
  'Returned by buyer' => 'Returned by buyer',
  'Failed Delivery' => 'Failed Delivery',
  'Failed to deliver' => 'Failed to deliver',
  'Order Items Type Split: Physical vs Digital Goods' => 'Order Items Type Split: Physical vs Digital Goods',
  'Physical Product Order Items' => 'Physical Product Order Items',
  'Digital Product Order Items' => 'Digital Product Order Items',
  'Vendor Ecosystem & Subscription Analytics' => 'Vendor Ecosystem & Subscription Analytics',
  'Earnings Statistics Trend' => 'Earnings Statistics Trend',
  'In preparation' => 'In preparation',
  'Out for Delivery' => 'Out for Delivery',
  'Dispatched with agent' => 'Dispatched with agent',
  'Manage All Vendors' => 'Manage All Vendors',
  'Total Vendors' => 'Total Vendors',
  'Expiring Subscriptions' => 'Expiring Subscriptions',
  'Expiring in next 30 days' => 'Expiring in next 30 days',
  'Vendor Waiting List' => 'Vendor Waiting List',
  'Vendors awaiting store activation' => 'Vendors awaiting store activation',
  'Denied / Suspended' => 'Denied / Suspended',
  'Blocked or rejected seller applications' => 'Blocked or rejected seller applications',
  'Subscription Plan Distribution' => 'Subscription Plan Distribution',
  'Active Vendors' => 'Active Vendors',
  'Top Earner Vendors' => 'Top Earner Vendors',
  'Store / Vendor' => 'Store / Vendor',
  'Customer Growth & Retention Analytics' => 'Customer Growth & Retention Analytics',
  'Manage Customers' => 'Manage Customers',
  'Registered Customers' => 'Registered Customers',
  'Blocked' => 'Blocked',
  'Average Lifetime Value (CLV)' => 'Average Lifetime Value (CLV)',
  'Avg spend per registered user' => 'Avg spend per registered user',
  'Repeat Buyers' => 'Repeat Buyers',
  'Customers with  1 completed order' => 'Customers with  1 completed order',
  'One-Time Buyers' => 'One-Time Buyers',
  'Single purchase customers' => 'Single purchase customers',
  'Loyalty Points Ecosystem' => 'Loyalty Points Ecosystem',
  'Total Points Issued' => 'Total Points Issued',
  'Product Catalog & Inventory Health' => 'Product Catalog & Inventory Health',
  'Manage Products' => 'Manage Products',
  'Out of Stock' => 'Out of Stock',
  'Zero quantity in stock' => 'Zero quantity in stock',
  'Low Stock ( = 5)' => 'Low Stock ( = 5)',
  'Re-order threshold reached' => 'Re-order threshold reached',
  'Total Wishlisted Items' => 'Total Wishlisted Items',
  'Saved by buyers' => 'Saved by buyers',
  'Product Reviews & Rating Health' => 'Product Reviews & Rating Health',
  'Avg Rating (out of 5)' => 'Avg Rating (out of 5)',
  'Total Customer Reviews' => 'Total Customer Reviews',
  'Reviews Pending Moderation' => 'Reviews Pending Moderation',
  '1-Star Critical Reviews' => '1-Star Critical Reviews',
  'Rating Distribution (1 - 5 Stars)' => 'Rating Distribution (1 - 5 Stars)',
  'Delivery & Logistics Fleet Analytics' => 'Delivery & Logistics Fleet Analytics',
  'Manage Delivery Men' => 'Manage Delivery Men',
  'Total Delivery Agents' => 'Total Delivery Agents',
  'Active Agents' => 'Active Agents',
  'Uncollected Cash in Hand' => 'Uncollected Cash in Hand',
  'Held by agents from COD orders' => 'Held by agents from COD orders',
  'Pending Delivery Payouts' => 'Pending Delivery Payouts',
  'Awaiting admin payout approval' => 'Awaiting admin payout approval',
  'Total Payouts Completed' => 'Total Payouts Completed',
  'Paid out to delivery men' => 'Paid out to delivery men',
  'Top Delivery Performers' => 'Top Delivery Performers',
  'Delivery Man' => 'Delivery Man',
  'Total Orders Delivered' => 'Total Orders Delivered',
  'No deliverymen data available' => 'No deliverymen data available',
  'Refunds & Support Operations Analytics' => 'Refunds & Support Operations Analytics',
  'Pending Refunds' => 'Pending Refunds',
  'Action required by admin' => 'Action required by admin',
  'Approved Refund Amount' => 'Approved Refund Amount',
  'approved requests' => 'Approved requests',
  'Refund Rate %' => 'Refund Rate %',
  'Refunds vs Delivered orders' => 'Refunds vs Delivered orders',
  'Open Support Tickets' => 'Open Support Tickets',
  'Customer support tickets' => 'Customer support tickets',
  'Support Tickets Overview' => 'Support Tickets Overview',
  'Open / Unresolved' => 'Open / Unresolved',
  'Closed / Solved' => 'Closed / Solved',
  'Chat & Engagement Activity' => 'Chat & Engagement Activity',
  'Total Messages Exchanged' => 'Total Messages Exchanged',
  'Direct communications between buyers  sellers  and delivery staff' => 'Direct communications between buyers  sellers  and delivery staff',
  'System Action Alerts & Live Stream' => 'System Action Alerts & Live Stream',
  'Action Required Items' => 'Action Required Items',
  'Pending Vendor Applications' => 'Pending Vendor Applications',
  'Pending Vendor Payout Requests' => 'Pending Vendor Payout Requests',
  'Pending Delivery Payout Requests' => 'Pending Delivery Payout Requests',
  'Pending Refund Requests' => 'Pending Refund Requests',
  'Low / Out of Stock Items' => 'Low / Out of Stock Items',
  'Expiring Vendor Subscriptions (  7d)' => 'Expiring Vendor Subscriptions (  7d)',
  'Latest Orders Activity Stream' => 'Latest Orders Activity Stream',
  'View All Orders' => 'View All Orders',
  'Guest User' => 'Guest User',
  'Order Status Visual Volume Breakdown' => 'Order Status Visual Volume Breakdown',
  'Customer Retention: Repeat vs One-Time Buyers' => 'Customer Retention: Repeat vs One-Time Buyers',
  'Customer Wallet Funds' => 'Customer Wallet Funds',
  'Total Active Customer Wallet Liabilities' => 'Total Active Customer Wallet Liabilities',
  'Stored funds usable for instant checkout' => 'Stored funds usable for instant checkout',
