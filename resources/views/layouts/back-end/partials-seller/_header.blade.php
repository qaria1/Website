    ...
    <header id="header"
        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-left">
                ...
                @php($currentEndDate = \App\Models\SellerSubscription::where('seller_id', auth('seller')->id())->where('status', true)->first()?->current_end)
                            ...
                            <div id="messageDropdown"
                                 ...
                                 <a class="dropdown-item position-relative"
                                   href="{{route('vendor.messages.index', ['type' => 'admin'])}}">
                                    ...
                                    @php($messageAdmin=\App\Models\Chatting::where(['seen_by_seller'=>0, 'seller_id'=>auth('seller')->id()])->where(['admin_id' => 0])->count())
                                    @if($messageAdmin > 0)
                                        <span
