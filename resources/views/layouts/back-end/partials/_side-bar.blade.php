                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        ...
                                        <span class="badge badge-soft-info badge-pill mx-2 px-2" title="{{ translate('total_new_pending_orders') }}">
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        ...
                                        <span class="badge badge-soft-info badge-pill mx-2 px-2" title="{{ translate('total_new_pending_refund_requests') }}">
                        ...
                        @if (Helpers::module_permission_check('product_management'))
                            <li
                                class="nav-item {{ Request::is('admin/delivery-class*') || Request::is('admin/brand*') || Request::is('admin/category*') || Request::is('admin/sub*') || Request::is('admin/attribute*') || Request::is('admin/products*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                                    title="">{{ translate('product_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-class*') || Request::is('admin/category*') || Request::is('admin/sub-category*') || Request::is('admin/sub-sub-category*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/delivery-class*') || Request::is('admin/category*') || Request::is('admin/sub*') ? 'block' : '' }}">
                                    <li
                                    ...
                                    <li class="nav-item {{ Request::is('admin/delivery-class*') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.delivery-class.index') }}"
                                            title="{{ translate('delivery_class') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('delivery_class') }}</span>
                                        </a>
                                    </li>

                                    <li
                                        class="nav-item {{ Request::is('admin/category-refund-dates*') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('admin.category-refund-dates.index') }}"
                                            title="{{ translate('Refund_Day_limit') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ translate('refund_day_limit') }}</span>
                                        </a>
                                    </li>
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/products/' . Product::LIST[URI] . '/seller*') || Request::is('admin/products/' . \App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI]) ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('vendor_Products') }}">
                                    <i class="tio-airdrop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('vendor_Products') }}
                                        <span class="badge badge-soft-info badge-pill mx-2 px-2" title="{{ translate('total_new_requests') }}">
                                            {{ \App\Models\Product::where(['request_status' => 0])->count() }}
                                        </span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link" title="{{ translate('new_Products_Requests') }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ translate('new_Products_Requests') }}
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Models\Product::where(['request_status' => 0])->count() }}
                                                </span>
                                            </span>
                                    ...
                                    @if (getWebConfig(name: 'product_wise_shipping_cost_approval') == 1)
                                        <li
                                            ...
                                            <a class="nav-link" title="{{ translate('product_Updated_Requests') }}"
                                                ...
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span
                                                    class="text-truncate">{{ translate('product_Updated_Requests') }}
                                                </span>
                                            </a>
                                        </li>
                                    @endif
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            ...
                                            <img src="{{ asset('public/assets/back-end/img/icons/send-notification.svg') }}"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/' . PushNotification::INDEX[URI]) || Request::is('admin/push-notification/' . PushNotification::INDEX[URI]) ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.push-notification.index') }}"
                                            title="{{ translate('push_notification') }}">
                                            <img src="{{ asset('public/assets/back-end/img/icons/push-notification.svg') }}"
                        ...
                        @if (Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('vendors') }}
                                        <span class="badge badge-soft-info badge-pill mx-2 px-2" title="{{ translate('total_new_sign_up_requests') }}">
                                            {{ \App\Models\Seller::where(['status' => 'pending'])->count() }}
                                        </span>
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/sign-up-request') || Request::is('admin/sellers/sign-up-request') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ translate('vendor_List') }}"
                                            href="{{ route('admin.sellers.sign-up-request') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ translate('sign_Up_Requests') }}
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Models\Seller::where(['status' => 'pending'])->count() }}
                                                </span>
                                            </span>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/' . 'waiting-list') || Request::is('admin/sellers/' . 'waiting-list' . '*') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ translate('vendor_List') }}"
                                            href="{{ route('admin.sellers.waiting-list.index') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ translate('free_Plan_Waiting_List') }}
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ \App\Models\SellerWaitingList::get()->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/' . 'subscription-expire') || Request::is('admin/sellers/' . 'subscription-expire' . '*') ? 'active' : '' }}">
                                        <a class="nav-link" title="{{ translate('vendor_List') }}"
                                            href="{{ route('admin.sellers.subscription-due-expire.index') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                {{ translate('expiring_Vendors') }}

                                                @php($expireDateRange = \Carbon\Carbon::now()->addDays(11))
                                                @php($planExpireSellers = \App\Models\SellerSubscription::where('status', true)->where('current_end', '<', $expireDateRange)->get())
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                    {{ $planExpireSellers->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                            ...
                            {{-- <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-man/' . Chatting::VIEW[URI]) ? 'active' : '' }}">
                        ...
                        @if (Helpers::module_permission_check('system_settings'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/mail' . Mail::VIEW[URI]) ||
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/web-config/' . EnvironmentSettings::VIEW[URI]) ||
