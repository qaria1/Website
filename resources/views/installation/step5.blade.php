...
@section('content')
    <div class="text-center text-white mb-4">
        <h2>{{ "martreza Software Installation" }}</h2>
        <h6 class="fw-normal">
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="martreza Software Installation"
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="company_name"
                                           required placeholder="Ex: martreza">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
