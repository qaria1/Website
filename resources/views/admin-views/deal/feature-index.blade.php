                        ...
                        <form action="{{route('admin.deal.flash')}}"
                            ...
                            <ul class="nav nav-tabs w-fit-content mb-4">
                                @foreach($language as $lang)
                                    <li class="nav-item text-capitalize">
                                        <a class="nav-link lang_link {{$lang == $defaultLanguage? 'active':''}}"
                                           href="javascript:"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    @foreach($language as $lang)
                                        <div class="col-md-12 {{$lang != $defaultLanguage ? 'd-none':''}} lang_form"
                                             id="{{$lang}}-form">
                                            <label for="name"
                                                   class="title-color text-capitalize">{{ translate('title')}}
                                                ({{strtoupper($lang)}})</label>
                                            <input type="text" name="title[]" class="form-control" id="title"
                                                   placeholder="{{translate('ex').':'.translate('your_input_here')}}" {{$lang == $defaultLanguage? 'required':''}}>
                                        </div>
