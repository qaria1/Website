...
@section('content')
                ...
                <div class="d-flex flex-wrap gap-3 justify-content-between">
                    ...
                    @if ($seller->status == 'pending')
                        <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">
                            {{-- <form class="d-inline-block" action="{{ route('admin.sellers.updateStatus') }}"
                                ...
                                <button type="submit"
                                    class="btn btn-danger px-5">{{ translate('reject_vendor') }}</button>
                            </form> --}}

                            <div class="d-inline-block">
                                <button type="button" class="btn rounded btn-danger" data-toggle="modal"
                                    data-target="#rejectVendorModal">{{ translate('reject_vendor') }}
                                </button>
                            </div>
                            ...
                            <form class="d-inline-block" action="{{ route('admin.sellers.updateStatus') }}"
                                ...
                                <button type="submit"
                                    class="btn btn-success px-5">{{ translate('approve_vendor') }}</button>
                            </form>
                        </div>
                    @endif
                    @if ($seller->status == 'approved')
                        <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">
                            ...
                            <div class="d-inline-block">
                                <div class="alert alert-light border mr-1" role="alert">
                                    <span class="mr-3">{{ translate('current_active_plan') }}: <span class="badge-primary badge-pill py-1">{{ $seller->subscriptions?->where('status', 1)->first()?->plan?->name ?? translate('none') }} {{ $seller->subscriptions?->where('status', 1)->first()?->is_trial ? '('.translate('trial').')' : ''}}</span></span>
                                </div>
                                {{-- <button type="button" class="btn rounded btn-danger" data-toggle="modal"
                                    data-target="#suspendVendorModal">{{ translate('suspend_this_vendor') }}
                                </button> --}}
                            </div>
                    ...
                    @if ($seller->status == 'suspended' || $seller->status == 'rejected')
                        <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">
                            <form class="d-inline-block" action="{{ route('admin.sellers.updateStatus') }}"
                                ...
                                <input type="hidden" name="status" value="approved">
                                <button type="submit"
                                    class="btn btn-success px-5">{{ translate('activate_vendor') }}</button>
                            </form>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="row gy-3 flex-grow-1 w-100">
                        <div class="col-sm-6 col-xxl-3">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="key">{{ translate('brand_shop') }}</span>
                                    <span>:</span>
                                    <span class="value">
                                        <span class="badge badge-{{ $seller->brand_id === DEFAULT_BRAND ? 'warning' : 'info' }}">
                                            {{ $seller->brand_id === DEFAULT_BRAND ? translate('no') : translate('yes') }}
                                        </span>
                                    </span>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <img width="40" class="mb-2"
                                                    src="{{ asset('/public/assets/back-end/img/pw.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <img width="40"
                                                    src="{{ asset('/public/assets/back-end/img/tcg.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <img width="40"
                                                    src="{{ asset('/public/assets/back-end/img/aw.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <img width="40"
                                                    src="{{ asset('/public/assets/back-end/img/tdce.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <img width="40"
                                                    src="{{ asset('/public/assets/back-end/img/ttg.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="card card-body h-100 justify-content-center">
                                        <div class="d-flex gap-2 justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <img width="40"
                                                    src="{{ asset('/public/assets/back-end/img/cc.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
    ...
    @include('layouts.front-end.partials.modal._vendor-suspend', ['seller' => $seller])
    @include('layouts.front-end.partials.modal._vendor-reject', ['seller' => $seller])
