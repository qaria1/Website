    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                <span class="badge badge-soft-dark radius-50 fz-14">{{ \App\Models\Brand::where('id', '!=', DEFAULT_BRAND)->paginate(getWebConfig(name: 'pagination_limit'))?->total() }}</span>
            </h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                                ...
                                @foreach($brands as $key => $brand)
                                    ...
                                    {{-- Prevent default brand from displaying --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{!! $brand?->seller ? $brand?->seller?->f_name.' '.$brand?->seller?->l_name : '<span class="badge badge-soft-warning">'.translate("no_vendor").'</span>' !!}</td>
