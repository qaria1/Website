    ...
    <div class="">
        <div class="content-position-y">
            <table class="customers bs-0">
                ...
                <tr>
                    <td>3</td>
                    <td>{{translate('admin_Subscription')}}</td>
                    <td class="text-right">{{ \App\Utils\BackEndHelper::set_symbol(\App\Utils\BackEndHelper::usd_to_currency($earning_data['admin_subscription'])) }}</td>
                </tr>
                <tr>
                    <td>4</td>
