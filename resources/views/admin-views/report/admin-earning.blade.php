            ...
            <div class="left-content">
                <div class="left-content-card">
                    ...
                    <div class="coupon__discount w-100 text-right d-flex justify-content-between">
                        ...
                        <div class="text-center">
                            <strong class="text-info break-all">{{setCurrencySymbol(amount: usdToDefaultCurrency(amount: $earning_data['total_subscription']), currencyCode: getCurrencyCode()) }}</strong>
            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{translate('subscription_Earning')}}</th>
                    ...
                    @foreach($inhouse_earn as $key=>$earning)
                        ...
                        <tr>
                            ...
                            <td>{{setCurrencySymbol(amount: usdToDefaultCurrency(amount: $admin_subscription_earn[$key]), currencyCode: getCurrencyCode()) }}</td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <form action="{{ route('admin.report.admin-earning-duration-download-pdf') }}"
                                        ...
                                        <input type="hidden" name="admin_subscription"
                                               value="{{ $admin_subscription_earn[$key] }}">
                                        ...
                                        <input type="hidden" name="total_earning"
                                               value="{{ $inhouse_earning+$admin_commission_earn[$key]+$admin_subscription_earn[$key]+$shipping_earn[$key]+$total_tax[$key]-$discount_given[$key]-$refund_given[$key] }}">
