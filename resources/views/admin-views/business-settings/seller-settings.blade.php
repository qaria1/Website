...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="card">
                <div class="border-bottom px-4 py-3">
                    <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                        <img width="22" src="{{ asset('/public/assets/back-end/img/product_setup.png') }}"
                            alt="">
                    ...
                    <div class="row align-items-end">
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="commission" value="{{ $commission ?? 0 }}"
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                                ...
                                <label class="switcher" for="vendor-registration">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="seller_registration" id="vendor-registration"
                                        {{ $vendorRegistration == 1 ? 'checked' : '' }} value="1"
                                        data-modal-id = "toggle-modal" data-toggle-id = "vendor-registration"
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control form-group">
                                ...
                                <label class="switcher" for="minimum-order-amount-by-vendor">
                                    <input type="checkbox" value="1" class="switcher_input toggle-switch-message"
                                        ...
                                        data-modal-id="toggle-modal" data-toggle-id="minimum-order-amount-by-vendor"
        ...
        {{-- Commission Rules --}}
        <form action="{{ route('admin.business-settings.seller-settings.update-commission-rules') }}" method="POST">
            @csrf
            <div class="card mt-2">
                <div class="border-bottom px-4 py-3">
                    <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color">{{ translate('vendor') }}</label>
                                <select name="seller_id" class="js-select2-custom form-control">
                                    <option value="">{{ translate('all_vendors_global_rule') }}</option>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="max_price"
                                    placeholder="Enter max product price (optional)">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="commission_percent" required
        ...
        {{-- Existing Commission Rules List --}}
        <div class="card">
            <div class="border-bottom px-4 py-3">
                <h5 class="mb-0">{{ translate('existing_rules') }}</h5>
            </div>
                            ...
                            @forelse ($rules as $rule)
                                <tr>
                                    <td>
                                        ...
                                        @else
                                            <span class="badge badge-primary">{{ translate('global') }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="javascript:;"
                                                class="btn btn-outline-info btn-sm square-btn editCommissionBtn"
                                                data-id="{{ $rule->id }}" data-min="{{ $rule->min_price }}"
                                                data-max="{{ $rule->max_price }}"
                                                data-commission="{{ $rule->commission_percent }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            <form
                                                action="{{ route('admin.business-settings.seller-settings.update-commission-rules.destroy', $rule->id) }}"
                                                method="POST" onsubmit="return confirm('Delete this rule?');">
                                                @csrf
                                                @method('DELETE')
                                                <button
                                                    class="btn btn-outline-danger btn-sm brand-delete-button square-btn">
                ...
                <div class="modal-content">
                    <form id="editCommissionForm" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="editCommissionModalLabel">{{ translate('edit_commission_rule') }}
                            </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">{{ translate('min_price') }}</label>
                                <input type="number" class="form-control" name="min_price" id="editMinPrice" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">{{ translate('max_price') }}</label>
                                <input type="number" class="form-control" name="max_price" id="editMaxPrice">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">{{ translate('commission (%)') }}</label>
                                <input type="number" class="form-control" name="commission_percent"
                                    id="editCommissionPercent" required>
                            </div>
...
@push('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const editButtons = document.querySelectorAll('.editCommissionBtn');
            const form = document.getElementById('editCommissionForm');
            const minInput = document.getElementById('editMinPrice');
            const maxInput = document.getElementById('editMaxPrice');
            const commissionInput = document.getElementById('editCommissionPercent');
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const commission = this.dataset.commission;
                    form.action =
                        `/admin/business-settings/seller-settings/commission-rules-update/${id}`;
                    minInput.value = min;
