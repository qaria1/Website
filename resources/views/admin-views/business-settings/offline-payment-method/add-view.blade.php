                    ...
                    <div class="row">
                        <div class="col-xl-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="{{ translate('ex').':'.translate('bank_transfer') }}" name="method_name" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-end" id="{{ $inputFieldsRandomNumber }}">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="input_name[]" class="form-control" placeholder="{{ translate('ex').':'.translate('abyssinia_bank') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="input_data" class="title_color text-capitalize">{{ translate('input_data') }}</label>
                                    <input type="text" name="input_data[]" class="form-control" placeholder="{{ translate('ex').':'.translate('1000xxx') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row align-items-end" id="{{ $customerInputFieldsRandomNumber }}">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_input[]" class="form-control" placeholder="{{ translate('ex').':'.translate('account_number') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="customer_placeholder" class="title_color">{{ translate('placeholder') }}</label>
                                    <input type="text" name="customer_placeholder[]" class="form-control" placeholder="{{ translate('ex').':'.translate('enter_account_number') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
