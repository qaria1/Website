                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color">
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="top" title="{{translate('if_enabled,_the_pay_on_delivery_option_will_be_available_on_the_system').'.'}}">
                                    ...
                                    <label class="switcher" for="cash-on-delivery">
                                        <input type="checkbox" class="switcher_input toggle-switch-message" name="cash_on_delivery"
                                               ...
                                               data-on-title = "{{translate('want_to_Turn_ON_the_Pay_On_Delivery_option')}}"
                                               data-off-title = "{{translate('want_to_Turn_OFF_the_Pay_On_Delivery_option')}}"
                                               data-on-message = "<p>{{translate('if_enabled_customers_can_select_Pay_on_Delivery_as_a_payment_method_during_checkout')}}</p>"
                                               data-off-message = "<p>{{translate('if_disabled_the_Pay_on_Delivery_payment_method_will_be_hidden_from_the_checkout_page')}}</p>">
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                        <span class="title-color">
                                            ...
                                            <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="top" title="{{translate('offline_Payment_allows_customers_to_use_external_payment_methods._They_must_share_payment_details_afterward._Admin_can_set_whether_customers_can_make_offline_payments_by_enabling/disabling_this_button.
                                            ')}}">
                                                <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="">
                                            </span>
                                        </span>
