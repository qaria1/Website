        ...
        <div class="card card-top-bg-element">
            <div class="card-body">
                <div class="d-flex flex-wrap flex-lg-nowrap gap-3 justify-content-between">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap align-items-start gap-2 mb-2 min-h-50">
                                ...
                                @if ($product->denied_note && $product['request_status'] == 2)
                                    <div class="alert alert-danger bg-danger-light py-2" role="alert">
                                        <strong>{{ translate('denied_note') }} :</strong> {{ $product->denied_note }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="d-block">
                                            ...
                                            <div class="">
                                                <ul class="list-unstyled list-unstyled-py-2 mb-0">
                                                    ...
                                                    <li class="d-flex align-items-center font-size-sm">
                                                        ...
                                                        <span
                                                            class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">{{ translate('4') }}
                                                            {{ translate('star') }}</span>
                                                        <div class="progress flex-grow-1">
                                                            <div class="progress-bar" role="progressbar"
                                                    ...
                                                    <li class="d-flex align-items-center font-size-sm">
                                                        ...
                                                        <span
                                                            class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">{{ translate('3') }}
                                                            {{ translate('star') }}</span>
                                                        <div class="progress flex-grow-1">
                                                            <div class="progress-bar" role="progressbar"
                                                    ...
                                                    <li class="d-flex align-items-center font-size-sm">
                                                        ...
                                                        <span
                                                            class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">{{ translate('2') }}
                                                            {{ translate('star') }}</span>
                                                        <div class="progress flex-grow-1">
                                                            <div class="progress-bar" role="progressbar"
                                                    ...
                                                    <li class="d-flex align-items-center font-size-sm">
                                                        ...
                                                        <span
                                                            class="{{ Session::get('direction') === 'rtl' ? 'ml-3' : 'mr-3' }}">{{ translate('1') }}
                                                            {{ translate('star') }}</span>
                                                        <div class="progress flex-grow-1">
                                                            <div class="progress-bar" role="progressbar"
                                ...
                                @if (
                                    $product->digital_file_ready &&
                                        file_exists(base_path('storage/app/public/product/digital-product/' . $product->digital_file_ready)))
                    ...
                    @php($seller = \App\Models\Seller::where('id', $product['user_id'])->first())
                    @php($isProductArchived = $seller?->isProductArchived($product))
                    ...
                    <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">
                        <div>
                            <span class="badge badge-soft-danger p-3">{{ translate('product_has_been_archived') }}</span>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <div class="row gy-3 flex-grow-1">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <h4 class="mb-3">{{ translate('shop_information') }}</h4>
                            <div class="pair-list">
                                <div>
                                ...
                                <div>
                                    ...
                                    <span>:</span>
                                    <span class="value">{{ $product->seller?->shop?->address }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                <div>
                                    ...
                                    <span>:</span>
                                    <span class="value">{{ $product->seller?->f_name }} {{ $product->seller?->l_name }}</span>
                                </div>

                                <div>
                                    <span class="key">{{ translate('email') }}</span>
                                    <span>:</span>
                                    <span class="value">{{ $product->seller?->email }}</span>
                                </div>

                                <div>
                                    <span class="key">{{ translate('phone') }}</span>
                                    <span>:</span>
                                    <span class="value">{{ $product->seller?->phone }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">
                        ...
                        @if (
                            ($product->product_type == 'physical' && count(json_decode($product->choice_options)) > 0) ||
                                ...
                                <form
                                    ...
                                    <label class="switcher mx-auto">
                                        <input type="checkbox" class="switcher_input toggle-switch-message"
                                            name="status" id="reviews-status{{ $review['id'] }}"
