    ...
    <div class="content container-fluid">
                ...
                <div class="card mt-3 rest-part">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        data-element-id="{{ $product['sub_sub_category_id'] }}"
                            ...
                            <input type="hidden" name="brand_id" value="{{ DEFAULT_BRAND }}" />
                ...
                <div class="card mt-3 rest-part">
                    ...
                    <div class="card-body">
                        <div class="row align-items-end">
                            ...
                            <input type="hidden" min="0" value="{{usdToDefaultCurrency($product->shipping_cost) }}"
                                        step="1"
                                        placeholder="{{ translate('shipping_cost') }}"
                                        name="shipping_cost" class="form-control" required>
        ...
        @else
            <div class="text-center p-4">
                ...
                <p class="mb-0">{{ translate('sorry_this_product_has_been_archived_and_ended_its_lifecycle').'!' }}</p>
            </div>
        @endif
    </div>
