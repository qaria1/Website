...
@section('content')
            ...
            <div class="page-header pb-0 mb-0 border-0">
                <div class="flex-between align-items-center">
                    <div>
                        ...
                        <p>{{ translate('welcome_to_your_dashboard')}}.</p>
                    </div>
                </div>
            </div>
                                        ...
                                        data-hs-chartjs-options='{
                                            ...
                                            "data": {
                                              ...
                                              },
                                              {
                                                ...
                                                "data": [{{$subscriptionEarningStatisticsData[1]}},{{$subscriptionEarningStatisticsData[2]}},{{$subscriptionEarningStatisticsData[3]}},{{$subscriptionEarningStatisticsData[4]}},{{$subscriptionEarningStatisticsData[5]}},{{$subscriptionEarningStatisticsData[6]}},{{$subscriptionEarningStatisticsData[7]}},{{$subscriptionEarningStatisticsData[8]}},{{$subscriptionEarningStatisticsData[9]}},{{$subscriptionEarningStatisticsData[10]}},{{$subscriptionEarningStatisticsData[11]}},{{$subscriptionEarningStatisticsData[12]}}],
                                                "backgroundColor": "#5109b5",
                                                "hoverBackgroundColor": "#5109b5",
                                                "borderColor": "#5109b5"
                                              }]
                                            },
                                            "options": {
    ...
    <span id="message-subscription-text" data-text="{{ translate('subscription')}}"></span>
