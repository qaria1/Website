        ...
        <form action="{{ route('admin.customer.customer-settings') }}" method="post" id="update-settings">
            ...
            <div class="card mb-3 {{ $loyaltyPointStatus == 0?'opacity--40':'' }}">
                <div class="border-bottom px-4 py-3">
                    <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                        <i class="tio-award"></i>
                        {{translate('customer_Loyalty_Point_Earnings')}}
                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right"
                ...
                <div class="card-body">
                    <div class="row align-items-end gy-2">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="item_purchase_point">
                                    {{translate('balance_credited_for_purchasing_an_item').'(%)'}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                          data-placement="top"
                                          title="{{translate('please_input_the_value_in_percent_the_loyalty_point_will_be_calculated_based_on_a_percent')}}">
                                        <img width="16" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}"
                                             alt="">
                                    </span>
                                </label>
                        ...
                        @php($loyaltyPointBecomeMemberPoint=getWebConfig(name:'loyalty_point_become_member_point'))
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="loyalty_point_become_member_point">
                                    {{translate('balance_credited_for_becoming_a_member')}}
                                </label>
                                <input type="text" class="form-control" name="loyalty_point_become_member_point"
                                       {{ $loyaltyPointStatus == 0?'disabled':'' }}
                                       id="loyalty_point_become_member_point"
                                       placeholder="{{translate('ex').':'.'10'}}"
                                       value="{{ $loyaltyPointBecomeMemberPoint ?? 0 }}">
                            </div>
                        </div>

                        @php($loyaltyPointVisitPlatformPoint=getWebConfig(name:'loyalty_point_visit_platform_point'))
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="loyalty_point_visit_platform_point">
                                    {{translate('balance_credited_visiting_site_or_App_in_24hrs')}}
                                </label>
                                <input type="text" class="form-control" name="loyalty_point_visit_platform_point"
                                       id="loyalty_point_visit_platform_point"
                                       placeholder="{{translate('ex').':'.'10'}}"
                                       {{ $loyaltyPointStatus == 0?'disabled':'' }}
                                       value="{{ $loyaltyPointVisitPlatformPoint ?? 0 }}">
                            </div>
                        </div>

                        @php($loyaltyPointReferUserPoint=getWebConfig(name:'loyalty_point_refer_user_point'))
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="loyalty_point_refer_user_point">
                                    {{translate('balance_credited_for_referring_a_user')}}
                                </label>
                                <input type="text" class="form-control" name="loyalty_point_refer_user_point"
                                       id="loyalty_point_refer_user_point"
                                       placeholder="{{translate('ex').':'.'10'}}"
                                       {{ $loyaltyPointStatus == 0?'disabled':'' }}
                                       value="{{ $loyaltyPointReferUserPoint ?? 1 }}">
                            </div>
                        </div>

                        @php($loyaltyPointSocialMediaCheckPoint=getWebConfig(name:'loyalty_point_social_media_check_point'))
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="loyalty_point_social_media_check_point">
                                    {{translate('balance_credited_for_checking_our_social_media')}}
                                </label>
                                <input type="text" class="form-control" name="loyalty_point_social_media_check_point"
                                       id="loyalty_point_social_media_check_point"
                                       placeholder="{{translate('ex').':'.'10'}}"
                                       {{ $loyaltyPointStatus == 0?'disabled':'' }}
                                       value="{{ $loyaltyPointSocialMediaCheckPoint ?? 1 }}">
                            </div>
                        </div>

                        @php($loyaltyPointReviewItemPoint=getWebConfig(name:'loyalty_point_review_item_point'))
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="loyalty_point_review_item_point">
                                    {{translate('balance_credited_for_reviewing_an_item')}}
                                </label>
                                <input type="text" class="form-control" name="loyalty_point_review_item_point"
                                       id="loyalty_point_review_item_point"
                                       placeholder="{{translate('ex').':'.'10'}}"
                                       {{ $loyaltyPointStatus == 0?'disabled':'' }}
                                       value="{{ $loyaltyPointReviewItemPoint ?? 1 }}">
                            </div>
                        </div>

                        @php($loyaltyPointCompleteProfilePoint=getWebConfig(name:'loyalty_point_complete_profile_point'))
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="loyalty_point_complete_profile_point">
                                    {{translate('balance_credited_for_completing_their_profile')}}
                                </label>
                                <input type="text" class="form-control" name="loyalty_point_complete_profile_point"
                                       id="loyalty_point_complete_profile_point"
                                       placeholder="{{translate('ex').':'.'10'}}"
                                       {{ $loyaltyPointStatus == 0?'disabled':'' }}
                                       value="{{ $loyaltyPointCompleteProfilePoint ?? 1 }}">
                            </div>
                        </div>
                    </div>
                </div>
