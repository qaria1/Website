                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="transaction_type" id="" class="form-control" title="{{translate('select_transaction_type')}}">
                                            ...
                                            <option value="become_member" {{isset($transaction_status) && $transaction_status=='become_member'?'selected':''}}>{{ translate('become_member')}}</option>
                                            <option value="platform_visit" {{isset($transaction_status) && $transaction_status=='platform_visit'?'selected':''}}>{{ translate('platform_visit')}}</option>
                                            <option value="refer_user" {{isset($transaction_status) && $transaction_status=='refer_user'?'selected':''}}>{{ translate('refer_user')}}</option>
                                            ...
                                            <option value="review_item" {{isset($transaction_status) && $transaction_status=='review_item'?'selected':''}}>{{ translate('review_item')}}</option>
                                            <option value="complete_profile" {{isset($transaction_status) && $transaction_status=='complete_profile'?'selected':''}}>{{ translate('complete_profile')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
