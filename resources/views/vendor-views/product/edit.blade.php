...
@section('content')
    <div class="content container-fluid">
        ...
        {{-- Only unarchived products are editable --}}
                        ...
                        @foreach ($languages as $language)
                            ...
                            <div class="{{ $language != 'en' ? 'd-none' : '' }} form-system-language-form"
                                ...
                                <div class="form-group pt-4">
                                    ...
                                    <textarea name="description[]" class="textarea editor-textarea">{!! $translate[$language]['description'] ?? $product['details'] !!}</textarea>
                                </div>
                            </div>
                        @endforeach
                    </div>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" step="0.01"
                                        ...
                                        class="form-control" value={{ usdToDefaultCurrency($product['purchase_price']) ?? 0 }}
                                        required>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-3">
        ...
        @else
            <div class="text-center p-4">
                ...
                <p class="mb-0">{{ translate('sorry_this_product_has_been_archived_and_ended_its_lifecycle._You_can_not_edit').'!' }}</p>
            </div>
        @endif
    </div>
...
@push('script')
    ...
    <script>
        ...
        let thumbnail =
            '{{ productImagePath('thumbnail') . '/' . $product->thumbnail ?? asset('public/assets/back-end/img/400x400/img2.jpg') }}';
        $(function() {
            if (imageCount > 0) {
