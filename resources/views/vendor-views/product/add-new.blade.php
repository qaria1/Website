...
@section('content')
    <div class="content container-fluid">
        ...
        {{-- Allow product addition if active plan exists with enough product count --}}
        @php($sellerActivePlan = $seller->getActivePlanForSeller($seller))

        @if (!empty($sellerActivePlan))
            @php($sellerLeftProductCount = (int)$sellerActivePlan?->max_product_upload - (int)$seller->getTotalProductForActivePlan($seller))

            @if (isset($sellerLeftProductCount) && $sellerLeftProductCount !== 0)
                <form class="product-form text-start" action="{{ route('vendor.products.add') }}" method="POST"
                    ...
                    <div class="card mt-3 rest-part">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <label for="name"
                                            class="title-color">{{ translate('sub_Sub_Category') }}</label>
                        ...
                        @endif --}}
                                ...
                                <input type="hidden" name="brand_id" value="{{ auth('seller')->user()->brand_id }}" />
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3" id="digital_file_ready_show">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2">{{ translate('file_type') }}:
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="{{ translate('enter_tag') }}" name="tags" data-role="tagsinput">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <div class="d-flex gap-2 mb-2">
                                            ...
                                            <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                                title="{{ translate('add_the_purchase_price_for_this_product') }}.{{ translate('if_you_do_not_want_to_set_please_enter_0_as_default') }}.">
                                                <img src="{{ asset('public/assets/back-end/img/info-circle.svg') }}"
                                                    alt="">
                                            </span>
                                        </div>
                                        <input type="number" min="0" step="0.01"
                                            ...
                                            value="{{ old('purchase_price') ?? 0 }}" name="purchase_price"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <div class="d-flex gap-2">
                                            <label class="title-color" for="discount">{{ translate('discount_amount') }}
                                                <span
                                ...
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="form-group">
                                        <div class="d-flex gap-2">
                                            <label class="title-color"
                                                for="tax">{{ translate('tax_amount') }}(%)</label>
            ...
            @else
                <div class="text-center p-4">
                    ...
                    <p class="mb-0">{{ translate('sorry_you_have_used_all_allowed_product_limit.You_can_not_add_products_for_current_plan.') }}</p>
                    <p class="mb-0">{{ translate('either_upgrade_your_subscription_plan_or_continue_to_use_our_platform_without_product_uploads.') }}</p>
        ...
        @else
            <div class="text-center p-4">
                <img class="mb-3 w-160"
                    src="{{ asset('public/assets/back-end/svg/illustrations/sorry.svg') }}"
                    alt="{{translate('image_description')}}">
                <p class="mb-0">{{ translate('sorry_you_do_not_have_active_subscription_plan._You_can_not_add_products').'!' }}</p>
            </div>
        @endif
    ...
    <span id="image-path-of-product-upload-icon"
        data-path="{{ asset('public/assets/back-end/img/icons/product-upload-icon.svg') }}"></span>
    <span id="image-path-of-product-upload-icon-two"
        data-path="{{ asset('public/assets/back-end/img/400x400/img2.jpg') }}"></span>
