                                            ...
                                            <div class="">
                                                <div class="mt-3">
                                                    <div class="row">
                                                        ...
                                                        {{-- <div class="col-6">
                                                            <div class="form-group">
                                                                <label>{{ translate('zip_code')}}{{ translate('(optional)') }}
                                                                    <span class="text-danger">*</span>
                                                                </label>
                                                        ...
                                                        <input type="hidden" class="form-control" name="zip" id="zip" value="1000">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                            ...
                                            <div class="">
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" class="form-control" name="billing_zip" id="billing_zip" value="1000">
                                                    </div>
