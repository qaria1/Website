...
@section('title', $data['data_from'] == 'brand' ? translate('exclusive_').translate($data['data_from']).' '.translate('products') : translate($data['data_from']).' '.translate('products'))
        ...
        <div class="search-page-header">
            <div>
                <h5 class="font-semibold mb-1">
                    {{$data['data_from'] == 'brand' ? translate('exclusive_').translate(str_replace('_',' ',$data['data_from'])) : translate(str_replace('_',' ',$data['data_from']))}}
