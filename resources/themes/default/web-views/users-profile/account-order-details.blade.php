                                                ...
                                                <td class="order_table_td">
                                                    <div class="">
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-square d-sm-none get-view-by-onclick"
                                                                data-link="{{ route('generate-invoice', [$order->id]) }}">
                                                                <img src="{{ asset('public/assets/front-end/img/icons/downloads.png') }}"
                                                                    alt="">
                                                            </button>
                                            ...
                                            @foreach ($order->details as $key => $detail)
                                                ...
                                                @if ($product)
                                                    <tr>
                                                            ...
                                                            <div class="media gap-3 align-items-center">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <div class="d-flex flex-wrap gap-2 mt-2">
                                                                        ...
                                                                        @elseif(
                                                                            ...
                                                                            @else
                                                                                <span class="" data-toggle="tooltip"
                                                                                    ...
                                                                                    <a
                                                                                        class="btn btn-sm rounded btn--primary disabled">{{ translate('download') }}
                                                                                        <i
                                                                                            class="tio-download-from-cloud"></i></a>
                                                                                </span>
                                                                            @endif
                                                                        ...
                                                                        // dd($categories[$key]->id);
                                                                        // dd($allCategories->where('id', $categories[$key]->id)->first()->categoryRefundDate->number_of_days);
                                                                            ...
                                                                            @if ($order->order_status == 'delivered')
                                                                                @if (isset($detail->product))
                                                                                    <button type="button"
                                                                                        ...
                                                                                        @else
                                                                                            <i
                                                                                                class="tio-star-half"></i>{{ translate('review') }}
                                                                                        @endif
                                                                                    </button>
                                                                                @endif
                                                                                ...
                                                                                @if (
                                                                                    $length <=
                                                                                        $refund_day_limit +
                                                                                            $allCategories->where('id', $categories[$key]->id)->first()->categoryRefundDate->number_of_days &&
                                                                                        $detail->refund_request == 0)
                                                                                    <button
                                                        ...
                                                        <td class="text-right">
                                                            <span
                                                                class="font-weight-bold amount">{{ webCurrencyConverter(amount: $detail->price) }}
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endif
                                                ...
                                                <div class="media flex-wrap gap-2">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span class="d-flex justify-content-between">
                                                            @if ($detail->variant)
                                                                <small>
                                                                    <span class="text-muted">{{ translate('variant') }} :
                                                                    </span>
                                                                    {{ $detail->variant }}
                                                                </small>
                                                            @endif
                                                ...
                                                @if ($order->order_status == 'delivered')
                                                    ...
                                                    @if (
                                                        ...
                                                        <button class="btn btn-sm rounded btn--primary"
                                                            data-toggle="modal"
                                                            data-target="#refundModal{{ $detail->id }}">
                                                            {{ translate('refund') }}
                                                        </button>
                                                    @endif
                                                @endif
                                            ...
                                            <tbody class="totals">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-end">
                                                            <span>-
                                                                {{ webCurrencyConverter(amount: $summary['total_discount_on_product']) }}</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-end">
                                                            <span>-
                                                                {{ webCurrencyConverter(amount: $order->discount_amount) }}</span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                @if ($order->order_type != 'default_type')
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-end">
                                                                <span>-
                                                                    {{ webCurrencyConverter(amount: $extra_discount) }}</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endif
                            ...
                            <div class="d-flex flex-column gap-2 fs-12">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="text-dark"> <a class="text-body text-capitalize" href="Javascript:">
                                            {{ $order->customer->f_name ?? transalte('name_not_found') }}&nbsp;{{ $order->customer->l_name ?? '' }}
                                        </a> </span>
                                </div>
