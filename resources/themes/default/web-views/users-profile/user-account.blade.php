                        ...
                        <div class="card-inner">
                            <form class="mt-3 px-sm-2 pb-2" action="{{route('user-update')}}" method="post"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="phone" class="mb-2 text-capitalize">{{translate('additional_phone_number')}}
                                        </label>
                                        <input type="text" class="form-control" id="additional_phone_number"
                                               name="additional_phone" value="{{$customerDetail['additional_phone']}}" required>
                                    </div>

                                    {{-- <div class="form-group col-md-6 mb-0">
                                        <label for="country"
                                               class="mb-2 text-capitalize">{{translate('country')}} </label>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <select id="country" name="country" class="form-control js-select2-custom">
                                            @foreach(COUNTRIES as $country)
                                                <option value="{{$country['name']}}" {{ $customerDetail['country'] == $country['name'] ? 'selected' :'' }} >
                                                    {{$country['name']}}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="city"
                                               class="mb-2 text-capitalize">{{translate('city')}} </label>
                                        <input type="text" class="form-control" id="city" name="city"
                                               value="{{$customerDetail['city']}}" required>
                                    </div>

                                    <div class="form-group col-md-6 mb-0">
                                        <label for="street_address"
                                               class="mb-2 text-capitalize">{{translate('street_address')}} </label>
                                        <input type="text" class="form-control" id="street_address" name="street_address"
                                               value="{{$customerDetail['street_address']}}" required>
                                    </div>

                                    <div class="form-group col-md-6 mb-0">
                                        <label for="house_no"
                                               class="mb-2 text-capitalize">{{translate('house_no')}} </label>
                                        <input type="text" class="form-control" id="house_no" name="house_no"
                                               value="{{$customerDetail['house_no']}}" required>
                                    </div>
