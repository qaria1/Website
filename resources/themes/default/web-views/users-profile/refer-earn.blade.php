                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center share-on-social">
                                        @php
                                            $text = "Hi, Order anything from Martreza. If you are new to this website don’t forget to use " . $customer_detail->referral_code . " " ."as the referral code while signing up into Martreza.";
                                            $link = url('/');
                                        @endphp
                                        ...
                                        <span class="click-to-copy-data-value" data-value="{{ route('home') }}?referral_code={{ $customer_detail->referral_code }}">
                                            <img alt=""
