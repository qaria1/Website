                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="isTrialPlan">{{ translate('do_you_want_the_trial_plan') }}?
                                </label>
                                @if (isset($defaultTrialPlan))
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ translate('the_trial_plan_is_called') }} {{ $defaultTrialPlan->plan?->name . '.' }} {{ translate('you_can_use_it_for') }} {{ $defaultTrialPlan->duration_in_days }} {{ translate('days') }}">
                                        <img width="16"
                            ...
                            <div class="plan-selection-select row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <select name="subscription_plan"
                                        class="form-control fs-13 border-aliceblue action-get-billing-types"
                                        id="subscription"
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <select name="billing_type" class="form-control fs-13 border-aliceblue action-set-billing-type"
                                        id="billing-type-select">
                                        <option value="" disabled selected>{{ translate('select_subscription_first') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="text-center">
                                <a class="small"
                                    href="{{ route('vendor.auth.login') }}">{{ translate('already_have_an_account?_login.') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
