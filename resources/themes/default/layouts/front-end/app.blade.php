...
<body class="toolbar-enabled">
    ...
    `;
        $(document).on('click', '#cookie-accept', function() {
            document.cookie = 'martreza_cookie_consent=accepted; max-age=' + 60 * 60 * 24 * 30;
            $('#cookie-section').hide();
        });
        $(document).on('click', '#cookie-reject', function() {
            document.cookie = 'martreza_cookie_consent=reject; max-age=' + 60 * 60 * 24;
            $('#cookie-section').hide();
        });

        $(document).ready(function() {
            if (document.cookie.indexOf("martreza_cookie_consent=accepted") !== -1) {
                $('#cookie-section').hide();
            } else {
