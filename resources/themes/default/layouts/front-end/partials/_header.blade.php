              ...
              @php(
                    ...
                    <ul class="navbar-nav">
                                        ...
                                        <li class="__inline-17">
                                            ...
                                            <div class="align-baseline">
                                                @if($brand['brand_products_count'] > 0 )
                                                    <span title="{{ translate('total_products_under_this_brand') }}" class="count-value px-2">( {{ $brand['brand_products_count'] }} )</span>
                                                @endif
                                            </div>
                                        </li>
                                    @endforeach
                        ...
                        {{-- @if (empty(auth('customer')->id()))
                            <li class="nav-item dropdown">
                                <a class="nav-link text-capitalize"
                                href="{{url('login'.'/'.$adminLogin.'')}}">{{ translate('admin_login')}}</a>
                            </li>
                        @endif --}}
                    </ul>
                    @if(auth('customer')->check())
