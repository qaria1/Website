...
use App\Http\Controllers\Vendor\Notification\NewRequestNotificationController;
use App\Http\Controllers\Vendor\SubscriptionPlan\VendorSubscriptionPlanController;
...
Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'subscriptions', 'as' => 'subscriptions.'], function () {
            Route::controller(VendorSubscriptionPlanController::class)->group(function () {
                Route::get('/get-billing-types', 'getBillingTypes')->name('get-billing-types')->withoutMiddleware('seller');
            });
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'subscription', 'as' => 'subscription.'], function () {
                Route::controller(VendorSubscriptionPlanController::class)->group(function () {
                    Route::get('index', 'index')->name('index');
                    Route::post('get-history', 'getHistory')->name('history');
