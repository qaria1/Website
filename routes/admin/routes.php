...
use App\Http\Controllers\Admin\Vendor\WaitingListController;
...
use App\Enums\ViewPaths\Admin\Subscription;
...
use App\Http\Controllers\Admin\DeliveryClass\DeliveryClassController;
use App\Http\Controllers\Admin\Settings\BillingTypeSettingController;
...
use App\Http\Controllers\Admin\Settings\SubscriptionSettingController;
...
use App\Http\Controllers\CategoryRefundDates\CategoryRefundDatesController;
use App\Http\Controllers\Admin\Deliveryman\DeliveryManCashCollectController;
use App\Http\Controllers\Admin\Notification\NewRequestNotificationController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'subscriptions', 'as' => 'subscriptions.'], function () {
        Route::controller(SubscriptionPlanController::class)->group(function () {
            Route::get('/get-billing-types', 'getBillingTypes')->name('get-billing-types')->withoutMiddleware('admin');
        });
    });
    ...
    // Category
    Route::group(['prefix' => '/', 'middleware' => ['module:product_management']], function () {
        Route::resource('delivery-class', DeliveryClassController::class);
    })->name('delivery-class');


    //category delivery dates
    Route::group(['prefix' => '/', 'middleware' => ['module:product_management']], function () {
        Route::resource('category-refund-dates', CategoryRefundDatesController::class);
    })->name('category-refund-dates');
    ...
    Route::group(['prefix' => 'sellers', 'as' => 'sellers.', 'middleware' => ['module:user_section']], function () {
        ...
        Route::group(['prefix' => 'waiting-list', 'as' => 'waiting-list.'], function () {
            Route::controller(WaitingListController::class)->group(function (){
                Route::get('/', 'waitingList')->name('index');
                Route::get('waiting-list-add', 'createWaitingList')->name('add');
                Route::post('waiting-list-store', 'storeWaitingList')->name('store');
                Route::delete('waiting-list-delete', 'removeWaitingList')->name('delete');

            });
        });

        Route::group(['prefix' => 'subscription-expire', 'as' => 'subscription-due-expire.'], function () {
            Route::controller(SubscriptionPlanController::class)->group(function (){
                Route::get('index', 'subscriptionExpireList')->name('index');
            });
        });
        ...
        Route::group(['prefix' => 'subscription', 'as' => 'subscription.'], function () {
            Route::controller(SubscriptionPlanController::class)->group(function () {
                Route::get('/get-billing-types', 'getBillingTypes')->name('get-billing-types');
                Route::post('/update-subscription', 'updateSellerSubscription')->name('update');
    ...
    Route::group(['prefix' => 'request-notification', 'as' => 'request-notification.'], function () {
        Route::controller(NewRequestNotificationController::class)->group(function () {
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::group(['prefix' => 'language', 'as' => 'language.', 'middleware' => ['module:system_settings']], function () {
            Route::controller(LanguageController::class)->group(function () {
                ...
                Route::any('translate-all', 'autoTranslateAll')->name('auto-translate-all');
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::group(['prefix' => 'billing-type', 'as' => 'billing-type.', 'middleware' => ['module:system_settings']], function () {
            Route::controller(BillingTypeSettingController::class)->group(function () {
                Route::get('/index', 'index')->name('index');
                Route::get('update' . '/{id}', 'getUpdateView')->name('update');
                Route::post(Subscription::UPDATE[URI] . '/{id}', 'update');
                Route::post(Subscription::UPDATE_STATUS[URI], 'updateStatus')->name('update-status');
                Route::post('billing-add', 'addBillingType')->name('add');
            });
        });
