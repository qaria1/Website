...
Route::group(['namespace' => 'RestAPI\v3\seller', 'prefix' => 'v3/seller', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['middleware' => ['seller_api_auth']], function () {
        ...
        Route::group(['prefix' => 'subscription'], function () {
                Route::get('index', 'VendorSubscriptionController@index');
                Route::get('get-plan-history/{id}', 'VendorSubscriptionController@get_history');
                Route::get('get-plan-status', 'VendorSubscriptionController@get_plan_status');
        });
