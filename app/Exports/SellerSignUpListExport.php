...
class SellerSignUpListExport implements FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    use Exportable;
    protected $data;
    ...
    {
        return view('file-exports.seller-sign-up-request-list', [
            'data' => $this->data,
        ]);
    }
