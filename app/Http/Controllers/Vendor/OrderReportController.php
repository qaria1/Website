...
class OrderReportController extends Controller
{
    ...
    public function order_report_export_excel(Request $request){
        ...
        foreach ($orders as $order) {
            if(in_array($order->order_status, ['confirmed', 'delivered', 'processing', 'failed', 'out_for_delivery', 'returned'])){
                continue;
            }
            ...
            $data[] = array(
                ...
                // 'Shipping Charge' => BackEndHelper::set_symbol(BackEndHelper::usd_to_currency($order->shipping_cost - ($order->extra_discount_type == 'free_shipping_over_order_amount' ? $order->extra_discount : 0))),
