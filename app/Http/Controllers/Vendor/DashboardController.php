...
class DashboardController extends BaseController
{
    ...
    public function getView():View
    {
        ...
        $seller = \App\Models\Seller::findOrFail($vendorId);
        ...
        $wishlistProducts = auth('seller')->user()->product()
        ->whereHas('wishList') // Filter products with wishlist entries
        ->with('wishList') // Eager load wishlist entries
        ->get();
        ...
        $vendorEstimatedProfit = $seller->getVendorEstimatedProfit($seller);
        $vendorEarningProfit = $seller->getVendorEarningProfit($seller);
        ...
        $dashboardData = [
            ...
            'totalEstimatedProfit' => $vendorEstimatedProfit,
            'totalEarningProfit' => $vendorEarningProfit,
        ];
