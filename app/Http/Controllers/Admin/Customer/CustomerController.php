...
class CustomerController extends BaseController
{
    ...
    public function update(CustomerUpdateSettingsRequest $request): View|RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type:'loyalty_point_become_member_point', value:$request->get('loyalty_point_become_member_point', getWebConfig('loyalty_point_become_member_point')));
        $this->businessSettingRepo->updateOrInsert(type:'loyalty_point_visit_platform_point', value:$request->get('loyalty_point_visit_platform_point', getWebConfig('loyalty_point_visit_platform_point')));
        $this->businessSettingRepo->updateOrInsert(type:'loyalty_point_refer_user_point', value:$request->get('loyalty_point_refer_user_point', getWebConfig('loyalty_point_refer_user_point')));
        $this->businessSettingRepo->updateOrInsert(type:'loyalty_point_social_media_check_point', value:$request->get('loyalty_point_social_media_check_point', getWebConfig('loyalty_point_social_media_check_point')));
        $this->businessSettingRepo->updateOrInsert(type:'loyalty_point_review_item_point', value:$request->get('loyalty_point_review_item_point', getWebConfig('loyalty_point_review_item_point')));
        $this->businessSettingRepo->updateOrInsert(type:'loyalty_point_complete_profile_point', value:$request->get('loyalty_point_complete_profile_point', getWebConfig('loyalty_point_complete_profile_point')));
